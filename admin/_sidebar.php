...
<aside class="sidebar">
  ...
  <nav>
    <a href="/PortofolioF2/admin/dashboard.php" class="<?= $page_active === 'dashboard.php' ? 'active' : '' ?>">Tableau de bord</a>
    <a href="/PortofolioF2/admin/projets/liste.php" class="<?= $dir_active === 'projets' ? 'active' : '' ?>">Projets</a>
    <a href="/PortofolioF2/admin/utilisateurs/liste.php" class="<?= $dir_active === 'utilisateurs' ? 'active' : '' ?>">Administrateurs</a>
    <a href="/PortofolioF2/admin/messages/liste.php" class="<?= $dir_active === 'messages' ? 'active' : '' ?>">
      Messages <?php if ($nb_msg > 0) : ?><span class="badge"><?= (int)$nb_msg ?></span><?php endif; ?>
    </a>
    <a href="/PortofolioF2/admin/demandes/liste.php" class="<?= $dir_active === 'demandes' ? 'active' : '' ?>">
